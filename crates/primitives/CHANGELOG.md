...
## [3.0.0](https://github.com/CeciliaZ030/revm/compare/revm-primitives-v2.1.0...revm-primitives-v3.0.0) - 2024-03-08

### Added
- implement DatabaseCommit for DatabaseComponents ([#1163](https://github.com/CeciliaZ030/revm/pull/1163))
- add PrecompileError::Other ([#1165](https://github.com/CeciliaZ030/revm/pull/1165))
...
- add helper function for spec id ([#1130](https://github.com/CeciliaZ030/revm/pull/1130))
