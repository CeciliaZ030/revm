...
## [3.2.0](https://github.com/CeciliaZ030/revm/compare/revm-interpreter-v3.1.0...revm-interpreter-v3.2.0) - 2024-03-08

### Added
- use `impl` instead of `dyn` in `GetInspector` ([#1157](https://github.com/CeciliaZ030/revm/pull/1157))

### Other
- *(interpreter)* use already-computed sign in SAR ([#1147](https://github.com/CeciliaZ030/revm/pull/1147))
- *(interpreter)* factor out jump logic ([#1146](https://github.com/CeciliaZ030/revm/pull/1146))
