...
## [0.3.0](https://github.com/CeciliaZ030/revm/compare/revme-v0.2.2...revme-v0.3.0) - 2024-03-08

### Added
- use `impl` instead of `dyn` in `GetInspector` ([#1157](https://github.com/CeciliaZ030/revm/pull/1157))
- add evm script ([#1039](https://github.com/CeciliaZ030/revm/pull/1039))

### Other
- *(deps)* bump walkdir from 2.4.0 to 2.5.0 ([#1149](https://github.com/CeciliaZ030/revm/pull/1149))
